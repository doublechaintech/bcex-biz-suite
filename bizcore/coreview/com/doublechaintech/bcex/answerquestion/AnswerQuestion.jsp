<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.answerquestion.AnswerQuestion'%>
...
<c:set var="ownerBeanName" value="answerQuestion" scope="request"/>
<c:set var="ownerClassName" value="AnswerQuestion" scope="request"/>
...
<div class="row">
	...
	<% AnswerQuestion result = (AnswerQuestion)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="answerQuestion" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/answerquestion/AnswerQuestion$Summary.jsp" />
