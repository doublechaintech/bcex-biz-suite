...
<c:if test="${ empty startExamList}" >
	<div class="row" style="font-size: 30px;">
		<div class="col-xs-12 col-md-12" style="padding-left:20px">
		 ${userContext.localeMap['@not_found']}${userContext.localeMap['start_exam']}! 
		 <a href="./${ownerBeanName}Manager/addStartExam/${result.id}/"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
 ...
 <c:if test="${not empty startExamList}" >
    
    
<%

 	SmartList list=(SmartList)request.getAttribute("startExamList"); 
...
%>
    ...
    <div class="row" style="font-size: 30px;">
		<div class="col-xs-12 col-md-12" style="padding-left:20px">
		<i class='fa fa-table'></i> ${userContext.localeMap['start_exam']}(${totalCount})
		<a href="./${ownerBeanName}Manager/addStartExam/${result.id}/"><i class="fa fa-plus-square" aria-hidden="true"></i></a>
		 
		 		 	<div class="btn-group" role="group" aria-label="Button group with nested dropdown">		
	<c:forEach var="action" items="${result.actionList}">
		<c:if test="${'startExamList' eq action.actionGroup}">
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/${startExamListName};${startExamListName}CurrentPage=${page.pageNumber};${startExamListName}RowsPerPage=${rowsPerPage}/' 
	...
	<table class="table table-striped" pageToken='startExamListCurrentPage=${currentPageNumber}'>
		<thead><tr>
		<c:if test="${param.referName ne 'id'}">
	<th>${userContext.localeMap['start_exam.id']}</th>
</c:if>
	...
	<td class="select_candidate_td"
		...
		<div class="candidate_span" style="display:none;">
			<input type="text" data-provide="typeahead" class="input-sm form-control candidate-filter-input" autocomplete="off" />
				...
				<a href='#${ownerBeanName}Manager/removeStartExam/${result.id}/${item.id}/' class='delete-action btn btn-danger btn-xs'><i class="fa fa-trash-o fa-lg"></i> ${userContext.localeMap['@delete']}</a>
				<a href='#${ownerBeanName}Manager/copyStartExamFrom/${result.id}/${item.id}/' class='copy-action btn btn-success btn-xs'><i class="fa fa-files-o fa-lg"></i> ${userContext.localeMap['@copy']} </a>
