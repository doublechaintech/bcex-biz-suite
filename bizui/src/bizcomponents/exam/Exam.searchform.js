...
class ExamSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      examList: 1,
      'examList.searchField': fieldName,
      'examList.searchVerb': 'startsWith',
      'examList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'status'))
      ...
      dispatch({
        ...
        examSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
               ...
               <SelectObject 
                 ...
                 targetType={"status"} 
                 requestFunction={ExamService.requestCandidateStatus} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"user"} 
                    requestFunction={ExamService.requestCandidateUser} useForSearch />
...
export default Form.create()(ExamSearchForm)
