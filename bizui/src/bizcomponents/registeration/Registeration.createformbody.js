...
class RegisterationCreateFormBody extends Component {
  state = {
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.changeRequest} {...formItemLayout}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={RegisterationService.requestCandidateChangeRequest}/>
...
}))(Form.create()(RegisterationCreateFormBody))
