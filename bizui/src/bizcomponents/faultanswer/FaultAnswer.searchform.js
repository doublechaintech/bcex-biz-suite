...
import styles from './FaultAnswer.search.less'
...
class FaultAnswerSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      faultAnswerList: 1,
      'faultAnswerList.searchField': fieldName,
      'faultAnswerList.searchVerb': 'startsWith',
      'faultAnswerList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'topic'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'yourAnswer'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'rightAnswer'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'user'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'eq', 'exam'))
      ...
      dispatch({
        ...
        faultAnswerSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"user"} 
                    requestFunction={FaultAnswerService.requestCandidateUser} useForSearch />
 ...
 <Col md={8} sm={24}>
                    <Form.Item label="考试">
                  {getFieldDecorator('exam', {initialValue: tryinit('exam')})(
                  
                  <SelectObject 
                    disabled={!availableForEdit('exam')}
                    targetType={"exam"} 
                    requestFunction={FaultAnswerService.requestCandidateExam} useForSearch />
...
export default Form.create()(FaultAnswerSearchForm)
