...
class AnswerQuestionAssociateForm extends Component {
  state = {
            ...
            <Row gutter={16}>
              ...
              <Col lg={12} md={12} sm={24}>
                ...
                <SelectObject 
                    ...
                    targetType={"question"} 
                    requestFunction={AnswerQuestionService.requestCandidateQuestion}/>
...
}))(Form.create()(AnswerQuestionAssociateForm))
