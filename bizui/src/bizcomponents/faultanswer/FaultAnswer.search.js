...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{faultAnswerList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'user')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'user')}/> <ExamAssociateForm 
...
class FaultAnswerSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {FaultAnswerTable} = GlobalComponents;
    const {FaultAnswerSearchForm} = GlobalComponents;
    const {FaultAnswerModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <FaultAnswerSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,FaultAnswerModalTable,"faultAnswerIds")}
...
export default Form.create()(FaultAnswerSearch)
