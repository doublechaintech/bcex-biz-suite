<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/bcex/loginhistory/LoginHistory$Summary.jsp" />
