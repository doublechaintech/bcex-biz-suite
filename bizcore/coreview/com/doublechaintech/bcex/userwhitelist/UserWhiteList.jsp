<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/bcex/userwhitelist/UserWhiteList$Summary.jsp" />
