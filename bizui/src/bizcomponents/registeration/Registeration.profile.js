...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.RegisterationBase.renderItemOfList(item, targetComponents)

}



class RegisterationProfile extends Component {
...
}))(Form.create()(RegisterationProfile))
