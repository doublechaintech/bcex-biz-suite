<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.startexam.StartExam'%>
...
<c:set var="ownerBeanName" value="startExam" scope="request"/>
<c:set var="ownerClassName" value="StartExam" scope="request"/>
...
<div class="row">
	...
	<% StartExam result = (StartExam)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="startExam" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/startexam/StartExam$Summary.jsp" />
