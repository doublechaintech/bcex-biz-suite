...
import com.doublechaintech.bcex.CommonError;
import com.doublechaintech.bcex.DAOGroup;
import com.doublechaintech.bcex.ManagerGroup;

import com.doublechaintech.bcex.UserContextImpl;
import com.doublechaintech.bcex.userapp.UserApp;
import com.doublechaintech.bcex.BcexUserContext;
import com.doublechaintech.bcex.userapp.*;
import com.doublechaintech.bcex.listaccess.*;
import com.doublechaintech.bcex.objectaccess.*;
import com.doublechaintech.bcex.BcexObjectChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(BcexUserContext userContext){
    ...
    public Object resetPassword(BcexUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(BcexUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(BcexUserContext userContext,
    ...
    public SecUser manage(BcexUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(BcexUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(BcexUserContext userContext) {
    ...
    protected Object gotoApp(BcexUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(BcexUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(BcexUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(BcexUserContext userContex, int length){
    ...
    protected String getBeanName(BcexUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(BcexUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(BcexUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(BcexUserContext userContext, UserApp app){
    ...
    public Object home(BcexUserContext userContext) {
    ...
    public Object loginWithEmail(BcexUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(BcexUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(BcexUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(BcexUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(BcexUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(BcexUserContext userContext, String type, String userId,
            Password password) {
     ...
     */
    protected Object loginTheSecUserInternal(BcexUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(BcexUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(BcexUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        BcexUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected BcexObjectChecker checker;
    public BcexObjectChecker getChecker(){
        return checker;
    }
    
    public void setChecker(BcexObjectChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((BcexObjectChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected BcexUserContextImpl createNewConext(String path) {
        ...
        return new BcexUserContextImpl();
    ...
    public Object checkOtherLogin(BcexUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(BcexUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(BcexUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(BcexUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(BcexUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(BcexUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(BcexUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(BcexUserContext userContext) throws SecUserManagerException {
