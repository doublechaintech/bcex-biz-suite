...
import styles from './ExamRanking.search.less'
...
class ExamRankingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      examRankingList: 1,
      'examRankingList.searchField': fieldName,
      'examRankingList.searchVerb': 'startsWith',
      'examRankingList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        examRankingSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={ExamRankingService.requestCandidatePlatform} useForSearch />
...
export default Form.create()(ExamRankingSearchForm)
