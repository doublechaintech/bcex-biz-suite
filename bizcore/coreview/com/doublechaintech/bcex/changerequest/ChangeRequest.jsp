<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.changerequest.ChangeRequest'%>
...
<c:set var="ownerBeanName" value="changeRequest" scope="request"/>
<c:set var="ownerClassName" value="ChangeRequest" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="changeRequest" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/changerequest/ChangeRequest$Summary.jsp" />
...
<sky:include page="com/doublechaintech/bcex/changerequesttype/ChangeRequestType$Info.jsp" />
...
<sky:include page="com/doublechaintech/bcex/platform/Platform$Info.jsp" />
	...
	<c:if test='${not empty userContext.accessTokens["startExamList"] or ignoreListAccessControl}'>
		...
		<div id="startExamList" class="tab-pane fade sublist" refer-name="change_request">
	...
	<c:if test='${not empty userContext.accessTokens["answerQuestionList"] or ignoreListAccessControl}'>
		...
		<div id="answerQuestionList" class="tab-pane fade sublist" refer-name="change_request">
