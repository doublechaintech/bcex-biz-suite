...
public class CandidateContainerJDBCTemplateDAO extends BcexBaseDAOImpl implements CandidateContainerDAO{


			
		
	
  	private  CandidateElementDAO  candidateElementDAO;
 	public void setCandidateElementDAO(CandidateElementDAO pCandidateElementDAO){
 	
 		if(pCandidateElementDAO == null){
 			throw new IllegalStateException("Do not try to set candidateElementDAO to null.");
 		}
	 	this.candidateElementDAO = pCandidateElementDAO;
 	}
