...
class ChangeRequestSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ChangeRequestTable} = GlobalComponents;
    const {ChangeRequestSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ChangeRequestSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ChangeRequestModalTable,"changeRequestIds")}
...
export default Form.create()(ChangeRequestSearch)
