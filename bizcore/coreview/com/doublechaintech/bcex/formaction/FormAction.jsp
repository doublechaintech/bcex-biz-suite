<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.formaction.FormAction'%>
...
<sky:include page="com/doublechaintech/bcex/formaction/FormAction$Summary.jsp" />
