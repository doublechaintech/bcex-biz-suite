...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{wechatUserList:selectedRows}} owner={owner}  
...
class WechatUserSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {WechatUserTable} = GlobalComponents;
    const {WechatUserSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <WechatUserSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,WechatUserModalTable,"wechatUserIds")}
...
export default Form.create()(WechatUserSearch)
