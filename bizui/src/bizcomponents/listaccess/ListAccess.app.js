...
class ListAccessBizApp extends React.PureComponent {
	  ...
	  <Menu
       ...
       >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/listAccess/${this.props.listAccess.id}/dashboard`}><Icon type="dashboard" style={{marginRight:"20px"}}/><span>{appLocaleName(userContext,"Dashboard")}</span></Link>
             </Menu.Item>
 ...
 <Header style={{ position: 'fixed', zIndex: 1, width: '100%' }}>
        ...
        <Col {...naviBarResponsiveStyle} >
            <Dropdown overlay= {this.getNavMenuItems(this.props.listAccess)}>
