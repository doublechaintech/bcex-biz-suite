...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{examStatusList:selectedRows}} owner={owner}  
...
class ExamStatusSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ExamStatusTable} = GlobalComponents;
    const {ExamStatusSearchForm} = GlobalComponents;
    const {ExamStatusModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ExamStatusSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ExamStatusModalTable,"examStatusIds")}
...
export default Form.create()(ExamStatusSearch)
