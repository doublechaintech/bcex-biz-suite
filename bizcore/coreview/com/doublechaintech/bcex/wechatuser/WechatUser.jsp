<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.wechatuser.WechatUser'%>
...
<c:set var="ownerBeanName" value="wechatUser" scope="request"/>
<c:set var="ownerClassName" value="WechatUser" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="wechatUser" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/wechatuser/WechatUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/bcex/platform/Platform$Info.jsp" />
	...
	<c:if test='${not empty userContext.accessTokens["wechatLoginInfoList"] or ignoreListAccessControl}'>
		<c:set var="wechatLoginInfoList" value="${result.wechatLoginInfoList}" scope="request"/>
		<c:set var="wechatLoginInfoListName" value="wechatLoginInfoList" scope="request"/>
		<div id="wechatLoginInfoList" class="tab-pane fade sublist" refer-name="wechat_user">
			<sky:include page="com/doublechaintech/bcex/wechatlogininfo/WechatLoginInfo$List.jsp"
					referName="wechatUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["examList"] or ignoreListAccessControl}'>
		<c:set var="examList" value="${result.examList}" scope="request"/>
		<c:set var="examListName" value="examList" scope="request"/>
		<div id="examList" class="tab-pane fade sublist" refer-name="user">
			<sky:include page="com/doublechaintech/bcex/exam/Exam$List.jsp"
					referName="user"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["faultAnswerList"] or ignoreListAccessControl}'>
		...
		<div id="faultAnswerList" class="tab-pane fade sublist" refer-name="user">
