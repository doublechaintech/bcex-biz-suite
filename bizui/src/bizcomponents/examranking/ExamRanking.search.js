...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{examRankingList:selectedRows}} owner={owner}  
...
class ExamRankingSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {ExamRankingTable} = GlobalComponents;
    const {ExamRankingSearchForm} = GlobalComponents;
    const {ExamRankingModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <ExamRankingSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,ExamRankingModalTable,"examRankingIds")}
...
export default Form.create()(ExamRankingSearch)
