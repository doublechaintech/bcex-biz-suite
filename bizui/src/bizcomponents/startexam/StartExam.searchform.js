...
import styles from './StartExam.search.less'
...
class StartExamSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      startExamList: 1,
      'startExamList.searchField': fieldName,
      'startExamList.searchVerb': 'startsWith',
      'startExamList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        startExamSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={StartExamService.requestCandidateChangeRequest} useForSearch />
...
export default Form.create()(StartExamSearchForm)
