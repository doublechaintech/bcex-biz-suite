...
import styles from './Exam.table.less'
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
          ...
          { hasReadPermission(metaInfo)&&<Link to={`/exam/${record.id}/dashboard`}>{appLocaleName(userContext,"View")}</Link>}
