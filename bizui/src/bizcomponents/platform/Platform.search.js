...
import styles from './Platform.search.less'
...
class PlatformSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {PlatformTable} = GlobalComponents;
    const {PlatformSearchForm} = GlobalComponents;
    const {PlatformModalTable} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,PlatformModalTable,"platformIds")}
...
export default Form.create()(PlatformSearch)
