...
<Description term="检查问题">{answerQuestion.question==null?appLocaleName(userContext,"NotAssigned"):`${answerQuestion.question.displayName}(${answerQuestion.question.id})`}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"检查问题","question",AnswerQuestionService.requestCandidateQuestion,
	      AnswerQuestionService.transferToAnotherQuestion,"anotherQuestionId",answerQuestion.question?answerQuestion.question.id:"")} 
  style={{fontSize: 20,color:"red"}} />
</Description>
