...
class WechatLoginInfoSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {WechatLoginInfoTable} = GlobalComponents;
    const {WechatLoginInfoSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <WechatLoginInfoSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,WechatLoginInfoModalTable,"wechatLoginInfoIds")}
...
export default Form.create()(WechatLoginInfoSearch)
