<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.objectaccess.ObjectAccess'%>
...
<sky:include page="com/doublechaintech/bcex/objectaccess/ObjectAccess$Summary.jsp" />
