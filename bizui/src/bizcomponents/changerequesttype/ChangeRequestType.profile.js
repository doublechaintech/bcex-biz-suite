...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.ChangeRequestTypeBase.renderItemOfList(item, targetComponents)

}



class ChangeRequestTypeProfile extends Component {
...
}))(Form.create()(ChangeRequestTypeProfile))
