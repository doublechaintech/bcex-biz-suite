...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.AnswerQuestionBase.renderItemOfList(item, targetComponents)

}



class AnswerQuestionProfile extends Component {
...
}))(Form.create()(AnswerQuestionProfile))
