...
import styles from './Registeration.search.less'
...
class RegisterationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      registerationList: 1,
      'registerationList.searchField': fieldName,
      'registerationList.searchVerb': 'startsWith',
      'registerationList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        registerationSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={RegisterationService.requestCandidateChangeRequest} useForSearch />
...
export default Form.create()(RegisterationSearchForm)
