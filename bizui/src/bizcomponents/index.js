...
import PlatformCreateFormBody from './platform/Platform.createformbody';
...
import StartExamDashboard from './startexam/StartExam.dashboard';
import StartExamModalTable from './startexam/StartExam.modaltable';
import StartExamSearch from './startexam/StartExam.search';
import StartExamSearchForm from './startexam/StartExam.searchform';
import StartExamCreateForm from './startexam/StartExam.createform';
import StartExamAssociateForm from './startexam/StartExam.associateform';
import StartExamTable from './startexam/StartExam.table';
import StartExamPermission from './startexam/StartExam.permission';
import StartExamProfile from './startexam/StartExam.profile';
import StartExamCreateFormBody from './startexam/StartExam.createformbody';
import StartExamService from './startexam/StartExam.service';
import StartExamUpdateForm from './startexam/StartExam.updateform';
import AnswerQuestionBase from './answerquestion/AnswerQuestion.base';
import AnswerQuestionBizApp from './answerquestion/AnswerQuestion.app';
import AnswerQuestionModel from './answerquestion/AnswerQuestion.model';
import AnswerQuestionDashboard from './answerquestion/AnswerQuestion.dashboard';
import AnswerQuestionModalTable from './answerquestion/AnswerQuestion.modaltable';
import AnswerQuestionSearch from './answerquestion/AnswerQuestion.search';
import AnswerQuestionSearchForm from './answerquestion/AnswerQuestion.searchform';
import AnswerQuestionCreateForm from './answerquestion/AnswerQuestion.createform';
import AnswerQuestionAssociateForm from './answerquestion/AnswerQuestion.associateform';
import AnswerQuestionTable from './answerquestion/AnswerQuestion.table';
import AnswerQuestionPermission from './answerquestion/AnswerQuestion.permission';
import AnswerQuestionProfile from './answerquestion/AnswerQuestion.profile';
import AnswerQuestionCreateFormBody from './answerquestion/AnswerQuestion.createformbody';
import AnswerQuestionService from './answerquestion/AnswerQuestion.service';
import AnswerQuestionUpdateForm from './answerquestion/AnswerQuestion.updateform';
import ExamStatusBase from './examstatus/ExamStatus.base';
import ExamStatusBizApp from './examstatus/ExamStatus.app';
import ExamStatusModel from './examstatus/ExamStatus.model';
import ExamStatusDashboard from './examstatus/ExamStatus.dashboard';
import ExamStatusModalTable from './examstatus/ExamStatus.modaltable';
import ExamStatusSearch from './examstatus/ExamStatus.search';
import ExamStatusSearchForm from './examstatus/ExamStatus.searchform';
import ExamStatusCreateForm from './examstatus/ExamStatus.createform';
import ExamStatusAssociateForm from './examstatus/ExamStatus.associateform';
import ExamStatusTable from './examstatus/ExamStatus.table';
import ExamStatusPermission from './examstatus/ExamStatus.permission';
import ExamStatusProfile from './examstatus/ExamStatus.profile';
import ExamStatusCreateFormBody from './examstatus/ExamStatus.createformbody';
import ExamStatusService from './examstatus/ExamStatus.service';
import ExamStatusUpdateForm from './examstatus/ExamStatus.updateform';
import QuestionBase from './question/Question.base';
import QuestionBizApp from './question/Question.app';
import QuestionModel from './question/Question.model';
import QuestionDashboard from './question/Question.dashboard';
import QuestionModalTable from './question/Question.modaltable';
import QuestionSearch from './question/Question.search';
import QuestionSearchForm from './question/Question.searchform';
import QuestionCreateForm from './question/Question.createform';
import QuestionAssociateForm from './question/Question.associateform';
import QuestionTable from './question/Question.table';
import QuestionPermission from './question/Question.permission';
import QuestionProfile from './question/Question.profile';
import QuestionCreateFormBody from './question/Question.createformbody';
import QuestionService from './question/Question.service';
import QuestionUpdateForm from './question/Question.updateform';
import ExamRankingBase from './examranking/ExamRanking.base';
import ExamRankingBizApp from './examranking/ExamRanking.app';
import ExamRankingModel from './examranking/ExamRanking.model';
import ExamRankingDashboard from './examranking/ExamRanking.dashboard';
import ExamRankingModalTable from './examranking/ExamRanking.modaltable';
import ExamRankingSearch from './examranking/ExamRanking.search';
import ExamRankingSearchForm from './examranking/ExamRanking.searchform';
import ExamRankingCreateForm from './examranking/ExamRanking.createform';
import ExamRankingAssociateForm from './examranking/ExamRanking.associateform';
import ExamRankingTable from './examranking/ExamRanking.table';
import ExamRankingPermission from './examranking/ExamRanking.permission';
import ExamRankingProfile from './examranking/ExamRanking.profile';
import ExamRankingCreateFormBody from './examranking/ExamRanking.createformbody';
import ExamRankingService from './examranking/ExamRanking.service';
import ExamRankingUpdateForm from './examranking/ExamRanking.updateform';
import AnswerBase from './answer/Answer.base';
import AnswerBizApp from './answer/Answer.app';
import AnswerModel from './answer/Answer.model';
import AnswerDashboard from './answer/Answer.dashboard';
import AnswerModalTable from './answer/Answer.modaltable';
import AnswerSearch from './answer/Answer.search';
import AnswerSearchForm from './answer/Answer.searchform';
import AnswerCreateForm from './answer/Answer.createform';
import AnswerAssociateForm from './answer/Answer.associateform';
import AnswerTable from './answer/Answer.table';
import AnswerPermission from './answer/Answer.permission';
import AnswerProfile from './answer/Answer.profile';
import AnswerCreateFormBody from './answer/Answer.createformbody';
import AnswerService from './answer/Answer.service';
import AnswerUpdateForm from './answer/Answer.updateform';
...
import ExamDashboard from './exam/Exam.dashboard';
import ExamModalTable from './exam/Exam.modaltable';
import ExamSearch from './exam/Exam.search';
import ExamSearchForm from './exam/Exam.searchform';
import ExamCreateForm from './exam/Exam.createform';
import ExamAssociateForm from './exam/Exam.associateform';
import ExamTable from './exam/Exam.table';
import ExamPermission from './exam/Exam.permission';
import ExamProfile from './exam/Exam.profile';
import ExamCreateFormBody from './exam/Exam.createformbody';
import ExamService from './exam/Exam.service';
import ExamUpdateForm from './exam/Exam.updateform';
import UserAnswerBase from './useranswer/UserAnswer.base';
import UserAnswerBizApp from './useranswer/UserAnswer.app';
import UserAnswerModel from './useranswer/UserAnswer.model';
import UserAnswerDashboard from './useranswer/UserAnswer.dashboard';
import UserAnswerModalTable from './useranswer/UserAnswer.modaltable';
import UserAnswerSearch from './useranswer/UserAnswer.search';
import UserAnswerSearchForm from './useranswer/UserAnswer.searchform';
import UserAnswerCreateForm from './useranswer/UserAnswer.createform';
import UserAnswerAssociateForm from './useranswer/UserAnswer.associateform';
import UserAnswerTable from './useranswer/UserAnswer.table';
import UserAnswerPermission from './useranswer/UserAnswer.permission';
import UserAnswerProfile from './useranswer/UserAnswer.profile';
import UserAnswerCreateFormBody from './useranswer/UserAnswer.createformbody';
import UserAnswerService from './useranswer/UserAnswer.service';
import UserAnswerUpdateForm from './useranswer/UserAnswer.updateform';
import FaultAnswerBase from './faultanswer/FaultAnswer.base';
import FaultAnswerBizApp from './faultanswer/FaultAnswer.app';
import FaultAnswerModel from './faultanswer/FaultAnswer.model';
import FaultAnswerDashboard from './faultanswer/FaultAnswer.dashboard';
import FaultAnswerModalTable from './faultanswer/FaultAnswer.modaltable';
import FaultAnswerSearch from './faultanswer/FaultAnswer.search';
import FaultAnswerSearchForm from './faultanswer/FaultAnswer.searchform';
import FaultAnswerCreateForm from './faultanswer/FaultAnswer.createform';
import FaultAnswerAssociateForm from './faultanswer/FaultAnswer.associateform';
import FaultAnswerTable from './faultanswer/FaultAnswer.table';
import FaultAnswerPermission from './faultanswer/FaultAnswer.permission';
import FaultAnswerProfile from './faultanswer/FaultAnswer.profile';
import FaultAnswerCreateFormBody from './faultanswer/FaultAnswer.createformbody';
import FaultAnswerService from './faultanswer/FaultAnswer.service';
import FaultAnswerUpdateForm from './faultanswer/FaultAnswer.updateform';
...
const ViewMapping = {
  ...
  'com.doublechaintech.bcex.question.Question': {name:'question'},
  ...
  'com.doublechaintech.bcex.userdomain.UserDomain': {name:'userDomain'},
  'com.doublechaintech.bcex.userwhitelist.UserWhiteList': {name:'userWhiteList'},
  'com.doublechaintech.bcex.secuser.SecUser': {name:'secUser'},
  'com.doublechaintech.bcex.secuserblocking.SecUserBlocking': {name:'secUserBlocking'},
  'com.doublechaintech.bcex.userapp.UserApp': {name:'userApp'},
  'com.doublechaintech.bcex.quicklink.QuickLink': {name:'quickLink'},
  'com.doublechaintech.bcex.listaccess.ListAccess': {name:'listAccess'},
  'com.doublechaintech.bcex.objectaccess.ObjectAccess': {name:'objectAccess'},
  'com.doublechaintech.bcex.loginhistory.LoginHistory': {name:'loginHistory'},
  'com.doublechaintech.bcex.genericform.GenericForm': {name:'genericForm'},
  'com.doublechaintech.bcex.formmessage.FormMessage': {name:'formMessage'},
  'com.doublechaintech.bcex.formfieldmessage.FormFieldMessage': {name:'formFieldMessage'},
  'com.doublechaintech.bcex.formfield.FormField': {name:'formField'},
  'com.doublechaintech.bcex.formaction.FormAction': {name:'formAction'},
  'com.doublechaintech.bcex.candidatecontainer.CandidateContainer': {name:'candidateContainer'},
  'com.doublechaintech.bcex.candidateelement.CandidateElement': {name:'candidateElement'},
...
const OOTBComponents={
    ...
    StartExamSearchForm,
    StartExamCreateForm,
    StartExamAssociateForm,
    StartExamTable,
    StartExamPermission,
    StartExamProfile,
    StartExamCreateFormBody,
    StartExamService,
    StartExamUpdateForm,
    AnswerQuestionBase,
    AnswerQuestionBizApp,
    AnswerQuestionModel,
    AnswerQuestionDashboard,
    AnswerQuestionModalTable,
    AnswerQuestionSearch,
    AnswerQuestionSearchForm,
    AnswerQuestionCreateForm,
    AnswerQuestionAssociateForm,
    AnswerQuestionTable,
    AnswerQuestionPermission,
    AnswerQuestionProfile,
    AnswerQuestionCreateFormBody,
    ...
    ExamStatusModel,
    ExamStatusDashboard,
    ExamStatusModalTable,
    ExamStatusSearch,
    ExamStatusSearchForm,
    ExamStatusCreateForm,
    ExamStatusAssociateForm,
    ExamStatusTable,
    ExamStatusPermission,
    ExamStatusProfile,
    ExamStatusCreateFormBody,
    ExamStatusService,
    ...
    QuestionSearchForm,
    QuestionCreateForm,
    QuestionAssociateForm,
    QuestionTable,
    QuestionPermission,
    QuestionProfile,
    QuestionCreateFormBody,
    QuestionService,
    QuestionUpdateForm,
    ExamRankingBase,
    ExamRankingBizApp,
    ExamRankingModel,
    ExamRankingDashboard,
    ExamRankingModalTable,
    ExamRankingSearch,
    ExamRankingSearchForm,
    ExamRankingCreateForm,
    ExamRankingAssociateForm,
    ExamRankingTable,
    ExamRankingPermission,
    ExamRankingProfile,
    ExamRankingCreateFormBody,
    ExamRankingService,
    ...
    UserAnswerModel,
    UserAnswerDashboard,
    UserAnswerModalTable,
    UserAnswerSearch,
    UserAnswerSearchForm,
    UserAnswerCreateForm,
    UserAnswerAssociateForm,
    UserAnswerTable,
    UserAnswerPermission,
    UserAnswerProfile,
    UserAnswerCreateFormBody,
    UserAnswerService,
    UserAnswerUpdateForm,
    FaultAnswerBase,
    FaultAnswerBizApp,
    FaultAnswerModel,
    FaultAnswerDashboard,
    FaultAnswerModalTable,
    FaultAnswerSearch,
    FaultAnswerSearchForm,
    FaultAnswerCreateForm,
    FaultAnswerAssociateForm,
    FaultAnswerTable,
    FaultAnswerPermission,
    FaultAnswerProfile,
    FaultAnswerCreateFormBody,
    FaultAnswerService,
