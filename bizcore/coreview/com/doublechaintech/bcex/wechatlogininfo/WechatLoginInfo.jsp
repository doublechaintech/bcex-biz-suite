<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.wechatlogininfo.WechatLoginInfo'%>
...
<c:set var="ownerBeanName" value="wechatLoginInfo" scope="request"/>
<c:set var="ownerClassName" value="WechatLoginInfo" scope="request"/>
...
<div class="row">
	...
	<% WechatLoginInfo result = (WechatLoginInfo)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="wechatLoginInfo" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/wechatlogininfo/WechatLoginInfo$Summary.jsp" />
	...
	<div class="row">
<c:set var="wechatUser" value="${ result.wechatUser}" scope="request" />
