<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.registration.Registration'%>
...
<c:set var="ownerBeanName" value="registration" scope="request"/>
<c:set var="ownerClassName" value="Registration" scope="request"/>
...
<div class="row">
	...
	<% Registration result = (Registration)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="registration" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/registration/Registration$Summary.jsp" />
