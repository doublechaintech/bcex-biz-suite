...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{answerQuestionList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'user')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'user')}/> <QuestionAssociateForm 
	visible={currentAssociateModal==='question'} 
	data={{answerQuestionList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'question')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'question')}/> <ChangeRequestAssociateForm 
...
class AnswerQuestionSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {AnswerQuestionTable} = GlobalComponents;
    const {AnswerQuestionSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <AnswerQuestionSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,AnswerQuestionModalTable,"answerQuestionIds")}
...
export default Form.create()(AnswerQuestionSearch)
