<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.platform.Platform'%>
...
<div class="row">
	...
	<% Platform result = (Platform)request.getAttribute("result");  %>
			...
			<li><a data-toggle="tab" href="#examStatusList" class="disabled"> ${userContext.localeMap['exam_status']}</a></li>
			<li><a data-toggle="tab" href="#questionList" class="disabled"> ${userContext.localeMap['question']}</a></li>
			<li><a data-toggle="tab" href="#examRankingList" class="disabled"> ${userContext.localeMap['exam_ranking']}</a></li>
...
<sky:include page="com/doublechaintech/bcex/platform/Platform$Summary.jsp" />
		...
		<div id="changeRequestTypeList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/bcex/changerequesttype/ChangeRequestType$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["changeRequestList"] or ignoreListAccessControl}'>
		...
		<div id="changeRequestList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/bcex/changerequest/ChangeRequest$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["examStatusList"] or ignoreListAccessControl}'>
		<c:set var="examStatusList" value="${result.examStatusList}" scope="request"/>
		<c:set var="examStatusListName" value="examStatusList" scope="request"/>
		<div id="examStatusList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/bcex/examstatus/ExamStatus$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["questionList"] or ignoreListAccessControl}'>
		...
		<div id="questionList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/bcex/question/Question$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["examRankingList"] or ignoreListAccessControl}'>
		<c:set var="examRankingList" value="${result.examRankingList}" scope="request"/>
		<c:set var="examRankingListName" value="examRankingList" scope="request"/>
		<div id="examRankingList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/bcex/examranking/ExamRanking$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["wechatUserList"] or ignoreListAccessControl}'>
		...
		<div id="wechatUserList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/bcex/wechatuser/WechatUser$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
