<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.userapp.UserApp'%>
...
<sky:include page="com/doublechaintech/bcex/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechaintech/bcex/secuser/SecUser$Info.jsp" />
		...
		<div id="quickLinkList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/bcex/quicklink/QuickLink$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["listAccessList"] or ignoreListAccessControl}'>
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/bcex/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/bcex/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
