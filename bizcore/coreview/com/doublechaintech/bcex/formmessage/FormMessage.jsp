<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/bcex/formmessage/FormMessage$Summary.jsp" />
