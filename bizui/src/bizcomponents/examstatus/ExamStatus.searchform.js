...
import styles from './ExamStatus.search.less'
...
class ExamStatusSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      examStatusList: 1,
      'examStatusList.searchField': fieldName,
      'examStatusList.searchVerb': 'startsWith',
      'examStatusList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        examStatusSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={ExamStatusService.requestCandidatePlatform} useForSearch />
...
export default Form.create()(ExamStatusSearchForm)
