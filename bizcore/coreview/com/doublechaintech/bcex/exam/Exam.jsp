<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.exam.Exam'%>
...
<c:set var="ownerBeanName" value="exam" scope="request"/>
<c:set var="ownerClassName" value="Exam" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="exam" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/exam/Exam$Summary.jsp" />
	...
	<div class="row">
<c:set var="examStatus" value="${ result.status}" scope="request" />
<c:set var="referName" value="(status)" scope="request" />
<sky:include page="com/doublechaintech/bcex/examstatus/ExamStatus$Info.jsp" />
