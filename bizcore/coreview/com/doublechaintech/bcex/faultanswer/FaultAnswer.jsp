<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.faultanswer.FaultAnswer'%>
...
<c:set var="ownerBeanName" value="faultAnswer" scope="request"/>
<c:set var="ownerClassName" value="FaultAnswer" scope="request"/>
...
<div class="row">
	...
	<% FaultAnswer result = (FaultAnswer)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="faultAnswer" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/faultanswer/FaultAnswer$Summary.jsp" />
