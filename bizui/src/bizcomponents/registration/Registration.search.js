...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{registrationList:selectedRows}} owner={owner}  
...
class RegistrationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RegistrationTable} = GlobalComponents;
    const {RegistrationSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RegistrationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RegistrationModalTable,"registrationIds")}
...
export default Form.create()(RegistrationSearch)
