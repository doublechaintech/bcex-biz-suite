<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.question.Question'%>
...
<c:set var="ownerBeanName" value="question" scope="request"/>
<c:set var="ownerClassName" value="Question" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="question" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/question/Question$Summary.jsp" />
...
<sky:include page="com/doublechaintech/bcex/platform/Platform$Info.jsp" />
		...
		<div id="answerList" class="tab-pane fade sublist" refer-name="question">
			<sky:include page="com/doublechaintech/bcex/answer/Answer$List.jsp"
					referName="question"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["userAnswerList"] or ignoreListAccessControl}'>
		<c:set var="userAnswerList" value="${result.userAnswerList}" scope="request"/>
		<c:set var="userAnswerListName" value="userAnswerList" scope="request"/>
		<div id="userAnswerList" class="tab-pane fade sublist" refer-name="question">
	...
	<c:if test='${not empty userContext.accessTokens["faultAnswerList"] or ignoreListAccessControl}'>
		...
		<div id="faultAnswerList" class="tab-pane fade sublist" refer-name="question">
