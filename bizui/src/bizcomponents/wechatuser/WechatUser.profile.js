...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.WechatUserBase.renderItemOfList(item, targetComponents)

}



class WechatUserProfile extends Component {
  ...
  render() {
    ...
    const { id,displayName, answerQuestionCount, wechatLoginInfoCount, examCount, faultAnswerCount } = wechatUser
