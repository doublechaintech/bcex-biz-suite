<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.candidatecontainer.CandidateContainer'%>
...
<sky:include page="com/doublechaintech/bcex/candidatecontainer/CandidateContainer$Summary.jsp" />
		...
		<div id="candidateElementList" class="tab-pane fade sublist" refer-name="container">
			<sky:include page="com/doublechaintech/bcex/candidateelement/CandidateElement$List.jsp"
					referName="container"/>
		</div>
	</c:if>
