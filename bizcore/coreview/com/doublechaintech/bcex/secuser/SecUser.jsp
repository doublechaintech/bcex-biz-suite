<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.secuser.SecUser'%>
...
<sky:include page="com/doublechaintech/bcex/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/bcex/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/doublechaintech/bcex/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/bcex/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/bcex/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
