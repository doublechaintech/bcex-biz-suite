...
class QuestionSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {QuestionTable} = GlobalComponents;
    const {QuestionSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,QuestionModalTable,"questionIds")}
...
export default Form.create()(QuestionSearch)
