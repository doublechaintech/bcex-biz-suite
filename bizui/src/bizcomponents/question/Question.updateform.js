...
import styles from './Question.updateform.less'
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, questionId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateQuestion`,
          payload: {
            id: owner.id,
            type: 'question',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextQuestionUpdateRow`,
        payload: {
          id: owner.id,
          type: 'question',
          selectedRows,
	...
	const internalRenderTitle = () =>{
      ...
      return (<div>{linkComp}{appLocaleName(userContext,"Update")}检查问题: {(currentUpdateIndex+1)}/{selectedRows.length}</div>)
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.topic} {...formItemLayout}>
                  {getFieldDecorator('topic', {
                    initialValue: selectedRow.topic,
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.optionA} {...formItemLayout}>
                  {getFieldDecorator('optionA', {
                    initialValue: selectedRow.optionA,
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.optionB} {...formItemLayout}>
                  {getFieldDecorator('optionB', {
                    initialValue: selectedRow.optionB,
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.optionC} {...formItemLayout}>
                  {getFieldDecorator('optionC', {
                    initialValue: selectedRow.optionC,
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.optionD} {...formItemLayout}>
                  {getFieldDecorator('optionD', {
                    initialValue: selectedRow.optionD,
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.optionE} {...formItemLayout}>
                  {getFieldDecorator('optionE', {
                    initialValue: selectedRow.optionE,
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.rightAnswer} {...formItemLayout}>
                  {getFieldDecorator('rightAnswer', {
                    initialValue: selectedRow.rightAnswer,
                    rules: [{ required: true, message: appLocaleName(userContext,"PleaseInput") }],
                  })(
...
}))(Form.create()(QuestionUpdateForm))
