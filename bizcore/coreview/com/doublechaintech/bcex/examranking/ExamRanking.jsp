<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.examranking.ExamRanking'%>
...
<c:set var="ownerBeanName" value="examRanking" scope="request"/>
<c:set var="ownerClassName" value="ExamRanking" scope="request"/>
...
<div class="row">
	...
	<% ExamRanking result = (ExamRanking)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="examRanking" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/examranking/ExamRanking$Summary.jsp" />
