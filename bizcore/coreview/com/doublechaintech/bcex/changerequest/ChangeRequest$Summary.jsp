...
<div class="col-xs-12 col-md-12 section">
	<b title="A ChangeRequest"> 
		${userContext.localeMap['change_request']}${userContext.localeMap['@word_space']}${userContext.localeMap['@summary']}
		</b>
...
<span class="summary-label">${userContext.localeMap['change_request.id']}</span>
<span >${result.id}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['change_request.name']}</span>
