...
import styles from './FormAction.updateform.less'
...
class FormActionUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextFormActionUpdateRow`,
        payload: {
          id: owner.id,
          type: 'formAction',
          selectedRows,
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item label={fieldLabels.actionKey} {...formItemLayout}>
                  {getFieldDecorator('actionKey', {
                    ...
                    <Input size="large" placeholder="行动的关键" />
...
}))(Form.create()(FormActionUpdateForm))
