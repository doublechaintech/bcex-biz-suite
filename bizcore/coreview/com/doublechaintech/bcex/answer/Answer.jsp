<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.answer.Answer'%>
...
<c:set var="ownerBeanName" value="answer" scope="request"/>
<c:set var="ownerClassName" value="Answer" scope="request"/>
...
<div class="row">
	...
	<% Answer result = (Answer)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="answer" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/answer/Answer$Summary.jsp" />
