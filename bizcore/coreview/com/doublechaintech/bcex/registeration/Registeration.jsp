<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.registeration.Registeration'%>
...
<c:set var="ownerBeanName" value="registeration" scope="request"/>
<c:set var="ownerClassName" value="Registeration" scope="request"/>
...
<div class="row">
	...
	<% Registeration result = (Registeration)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="registeration" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/registeration/Registeration$Summary.jsp" />
