...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{registerationList:selectedRows}} owner={owner}  
...
class RegisterationSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {RegisterationTable} = GlobalComponents;
    const {RegisterationSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <RegisterationSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,RegisterationModalTable,"registerationIds")}
...
export default Form.create()(RegisterationSearch)
