...
class PlatformSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      platformList: 1,
      'platformList.searchField': fieldName,
      'platformList.searchVerb': 'startsWith',
      'platformList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        platformSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(PlatformSearchForm)
