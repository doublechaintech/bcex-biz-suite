<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.changerequesttype.ChangeRequestType'%>
...
<c:set var="ownerBeanName" value="changeRequestType" scope="request"/>
<c:set var="ownerClassName" value="ChangeRequestType" scope="request"/>
...
<div class="row">
	...
	<% ChangeRequestType result = (ChangeRequestType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="changeRequestType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/changerequesttype/ChangeRequestType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/bcex/platform/Platform$Info.jsp" />
		...
		<div id="changeRequestList" class="tab-pane fade sublist" refer-name="request_type">
			<sky:include page="com/doublechaintech/bcex/changerequest/ChangeRequest$List.jsp"
					referName="requestType"/>
		</div>
	</c:if>
