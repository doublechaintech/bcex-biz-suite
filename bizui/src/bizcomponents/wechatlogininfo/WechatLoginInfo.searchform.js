...
import styles from './WechatLoginInfo.search.less'
...
class WechatLoginInfoSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      wechatLoginInfoList: 1,
      'wechatLoginInfoList.searchField': fieldName,
      'wechatLoginInfoList.searchVerb': 'startsWith',
      'wechatLoginInfoList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        wechatLoginInfoSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(WechatLoginInfoSearchForm)
