...
import styles from './Answer.search.less'
...
class AnswerSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      answerList: 1,
      'answerList.searchField': fieldName,
      'answerList.searchVerb': 'startsWith',
      'answerList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'comment'))
      ...
      dispatch({
        ...
        answerSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"question"} 
                    requestFunction={AnswerService.requestCandidateQuestion} useForSearch />
...
export default Form.create()(AnswerSearchForm)
