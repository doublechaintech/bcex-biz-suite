...
public class BcexBizUserContextImpl extends BcexUserContextImpl{
	...
	protected BaseBcexFormProcessor inputFormData;
	protected BaseBcexFormProcessor outputFormData;
	...
	public String getPostMd5Key(BcexBizUserContextImpl ctx) {
	...
	public BaseBcexFormProcessor getInputFormData() {
		return inputFormData;
	}
	public void setInputFormData(BaseBcexFormProcessor inputFormData) {
		this.inputFormData = inputFormData;
	}
	public BaseBcexFormProcessor getOutputFormData() {
		return outputFormData;
	}
	public void setOutputFormData(BaseBcexFormProcessor outputFormData) {
