...
import styles from './Registration.search.less'
...
class RegistrationSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      registrationList: 1,
      'registrationList.searchField': fieldName,
      'registrationList.searchVerb': 'startsWith',
      'registrationList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        registrationSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={RegistrationService.requestCandidateChangeRequest} useForSearch />
...
export default Form.create()(RegistrationSearchForm)
