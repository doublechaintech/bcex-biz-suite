...
public class FaultAnswerTable{
	...
	static final String COLUMN_FAULT_TIMES = "fault_times";
	static final String COLUMN_VERSION = "version";
 
	public static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_TOPIC, COLUMN_YOUR_ANSWER, COLUMN_RIGHT_ANSWER, COLUMN_CREATE_TIME, COLUMN_USER, COLUMN_QUESTION, COLUMN_FAULT_TIMES, 
		COLUMN_VERSION};
