...
import styles from './AnswerQuestion.search.less'
...
class AnswerQuestionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      answerQuestionList: 1,
      'answerQuestionList.searchField': fieldName,
      'answerQuestionList.searchVerb': 'startsWith',
      'answerQuestionList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'nickName'))
      ...
      dispatch({
        ...
        answerQuestionSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"user"} 
                    requestFunction={AnswerQuestionService.requestCandidateUser} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"question"} 
                    requestFunction={AnswerQuestionService.requestCandidateQuestion} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    requestFunction={AnswerQuestionService.requestCandidateChangeRequest} useForSearch />
...
export default Form.create()(AnswerQuestionSearchForm)
