...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.FaultAnswerBase.renderItemOfList(item, targetComponents)

}



class FaultAnswerProfile extends Component {
...
}))(Form.create()(FaultAnswerProfile))
