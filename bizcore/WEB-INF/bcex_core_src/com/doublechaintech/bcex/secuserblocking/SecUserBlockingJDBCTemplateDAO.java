...
public class SecUserBlockingJDBCTemplateDAO extends BcexBaseDAOImpl implements SecUserBlockingDAO{
	...
	*/
    ...
    public SmartList<SecUserBlocking> requestCandidateSecUserBlockingForSecUser(BcexUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
	...
	public SmartList<SecUser> loadOurSecUserList(BcexUserContext userContext, List<SecUserBlocking> us, Map<String,Object> options) throws Exception{
