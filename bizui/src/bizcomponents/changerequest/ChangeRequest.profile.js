...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.ChangeRequestBase.renderItemOfList(item, targetComponents)

}



class ChangeRequestProfile extends Component {
...
}))(Form.create()(ChangeRequestProfile))
