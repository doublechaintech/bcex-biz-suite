<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.quicklink.QuickLink'%>
...
<c:set var="ownerBeanName" value="quickLink" scope="request"/>
<c:set var="ownerClassName" value="QuickLink" scope="request"/>
...
<div class="row">
	...
	<% QuickLink result = (QuickLink)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="quickLink" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/quicklink/QuickLink$Summary.jsp" />
...
<c:set var="referName" value="(app)" scope="request" />
<sky:include page="com/doublechaintech/bcex/userapp/UserApp$Info.jsp" />
