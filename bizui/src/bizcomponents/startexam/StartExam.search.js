...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{startExamList:selectedRows}} owner={owner}  
...
class StartExamSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {StartExamTable} = GlobalComponents;
    const {StartExamSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <StartExamSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,StartExamModalTable,"startExamIds")}
...
export default Form.create()(StartExamSearch)
