...
import styles from './ChangeRequest.search.less'
...
class ChangeRequestSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      changeRequestList: 1,
      'changeRequestList.searchField': fieldName,
      'changeRequestList.searchVerb': 'startsWith',
      'changeRequestList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      dispatch({
        ...
        changeRequestSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(ChangeRequestSearchForm)
