...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{answerList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'question')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'question')}/> 
...
class AnswerSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {AnswerTable} = GlobalComponents;
    const {AnswerSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={renderTitle()}>
        ...
        {showDeletionDialog(this,AnswerModalTable,"answerIds")}
...
export default Form.create()(AnswerSearch)
