<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/bcex/secuserblocking/SecUserBlocking$Summary.jsp" />
