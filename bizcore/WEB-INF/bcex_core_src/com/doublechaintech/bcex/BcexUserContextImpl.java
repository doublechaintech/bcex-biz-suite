...
import com.doublechaintech.bcex.secuser.SecUserCustomManagerImpl;
...
public class BcexUserContextImpl extends UserContextImpl implements BcexUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.bcex.BcexResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.bcex.BcexCustomResources";
    ...
    /*
    public static SecUser getSecUser(BcexUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(BcexUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(BcexUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(BcexUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private BcexObjectChecker checker;
