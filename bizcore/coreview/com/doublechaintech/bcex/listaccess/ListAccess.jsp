<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/bcex/listaccess/ListAccess$Summary.jsp" />
