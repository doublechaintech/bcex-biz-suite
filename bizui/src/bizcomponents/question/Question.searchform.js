...
import styles from './Question.search.less'
...
class QuestionSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      questionList: 1,
      'questionList.searchField': fieldName,
      'questionList.searchVerb': 'startsWith',
      'questionList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'optionA'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'optionB'))
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'optionE'))
      ...
      dispatch({
        ...
        questionSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(QuestionSearchForm)
