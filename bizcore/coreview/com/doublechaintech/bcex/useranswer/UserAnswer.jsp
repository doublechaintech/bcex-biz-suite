<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.useranswer.UserAnswer'%>
...
<c:set var="ownerBeanName" value="userAnswer" scope="request"/>
<c:set var="ownerClassName" value="UserAnswer" scope="request"/>
...
<div class="row">
	...
	<% UserAnswer result = (UserAnswer)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userAnswer" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/useranswer/UserAnswer$Summary.jsp" />
...
<c:set var="exam" value="${ result.exam}" scope="request" />
<c:set var="referName" value="" scope="request" />
<sky:include page="com/doublechaintech/bcex/exam/Exam$Info.jsp" />
		...
		<div id="answerQuestionList" class="tab-pane fade sublist" refer-name="user_answer">
			<sky:include page="com/doublechaintech/bcex/answerquestion/AnswerQuestion$List.jsp"
					referName="userAnswer"/>
		</div>
	</c:if>
