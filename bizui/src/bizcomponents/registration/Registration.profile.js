...
const internalSummaryOf = (item, targetComponents)=>{
	...
	return GlobalComponents.RegistrationBase.renderItemOfList(item, targetComponents)

}



class RegistrationProfile extends Component {
...
}))(Form.create()(RegistrationProfile))
