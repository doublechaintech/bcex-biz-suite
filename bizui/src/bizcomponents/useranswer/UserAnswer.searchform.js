...
import styles from './UserAnswer.search.less'
...
class UserAnswerSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      userAnswerList: 1,
      'userAnswerList.searchField': fieldName,
      'userAnswerList.searchVerb': 'startsWith',
      'userAnswerList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'userSelect'))
      ...
      dispatch({
        ...
        userAnswerSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                    <Form.Item label="检查问题">
                  {getFieldDecorator('question', {initialValue: tryinit('question')})(
                  
                  <SelectObject 
                    disabled={!availableForEdit('question')}
                    targetType={"question"} 
                    requestFunction={UserAnswerService.requestCandidateQuestion} useForSearch />
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"exam"} 
                    requestFunction={UserAnswerService.requestCandidateExam} useForSearch />
...
export default Form.create()(UserAnswerSearchForm)
