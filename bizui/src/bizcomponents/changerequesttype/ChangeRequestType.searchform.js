...
class ChangeRequestTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      changeRequestTypeList: 1,
      'changeRequestTypeList.searchField': fieldName,
      'changeRequestTypeList.searchVerb': 'startsWith',
      'changeRequestTypeList.searchValue': fieldValue,
    }
  }
  */
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const {listName} = owner
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(listName, fieldsValue,'contains', 'icon'))
      ...
      dispatch({
        ...
        changeRequestTypeSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={ChangeRequestTypeService.requestCandidatePlatform} useForSearch />
...
export default Form.create()(ChangeRequestTypeSearchForm)
