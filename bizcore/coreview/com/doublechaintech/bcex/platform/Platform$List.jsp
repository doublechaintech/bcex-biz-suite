...
</c:if><c:if test="${param.referName ne 'description'}">	<td contenteditable='true' class='edit-value'  propertyToChange='description' storedCellValue='${item.description}' prefix='${ownerBeanName}Manager/updatePlatform/${result.id}/${item.id}/'><a title='${item.description}'>${fn:substring(item.description,0,10)}...</a></td>
</c:if>
				<td>
