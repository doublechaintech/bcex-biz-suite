<%@ page import='java.util.*,com.doublechaintech.bcex.*,com.doublechaintech.bcex.examstatus.ExamStatus'%>
...
<c:set var="ownerBeanName" value="examStatus" scope="request"/>
<c:set var="ownerClassName" value="ExamStatus" scope="request"/>
...
<div class="row">
	...
	<% ExamStatus result = (ExamStatus)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="examStatus" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/bcex/examstatus/ExamStatus$Summary.jsp" />
...
<sky:include page="com/doublechaintech/bcex/platform/Platform$Info.jsp" />
		...
		<div id="examList" class="tab-pane fade sublist" refer-name="status">
